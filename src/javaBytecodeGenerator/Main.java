...
public class Main {
	public static void main(String[] args) {
		...
		if (errorMsg != null && !errorMsg.anyErrors()) {
		    ...
		    // we translate in java bytecode, the Kitten code of every class which has 
		    // test and fixture
		    program.generateJavaBytecodeForTests();
		    
		    System.out.println("Java bytecode generation for Tests completed       \t[" + (System.currentTimeMillis() - time) + "ms]");
